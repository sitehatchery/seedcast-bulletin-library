...
final class Settings {
	...
	public function add_page(): void {
		add_options_page(
			__( 'Seedcast', 'seedcast-bulletin-library' ),
			__( 'Seedcast', 'seedcast-bulletin-library' ),
			'manage_options',
			self::PAGE,
			array( $this, 'render' )
	...
	public function register_settings(): void {
		...
		$this->add_section(
			'seedcast_suite',
			__( 'Suite', 'seedcast-bulletin-library' ),
		...
		$this->add_section(
			'seedcast_church',
			__( 'Church', 'seedcast-bulletin-library' ),
		...
		$this->add_section(
			'seedcast_appearance',
			__( 'Appearance', 'seedcast-bulletin-library' ),
		...
		$this->add_section(
			'seedcast_spam',
			__( 'Spam protection', 'seedcast-bulletin-library' ),
	...
	public function render(): void {
		...
		<div class="wrap sc-settings-wrap">
			<h1><?php esc_html_e( 'Seedcast', 'seedcast-bulletin-library' ); ?></h1>
			<?php
			/*
			...
			<nav class="sc-settings-nav nav-tab-wrapper" aria-label="<?php esc_attr_e( 'Settings sections', 'seedcast-bulletin-library' ); ?>">
	...
	public function render_church_section(): void {
		...
		<div class="sc-settings-card">
			<h2><?php esc_html_e( 'Church', 'seedcast-bulletin-library' ); ?></h2>
			<p class="description">
				<?php esc_html_e( 'Your church details, shared across every Seedcast plugin on this site. Change them here and everywhere they appear updates together.', 'seedcast-bulletin-library' ); ?>
			</p>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="seedcast_church_name"><?php esc_html_e( 'Church name', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						...
						<p class="description">
							...
							printf(
								...
								esc_html__( 'Leave blank to use the site title, %s.', 'seedcast-bulletin-library' ),
				...
				<tr>
					<th scope="row"><label for="seedcast_church_address"><?php esc_html_e( 'Street address', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						...
						<p class="description">
							<?php esc_html_e( 'The street and building only. City, state and postcode go in the fields below.', 'seedcast-bulletin-library' ); ?>
						</p>
						...
						<?php if ( count( $seedcast_address_lines ) > 1 && '' === \Seedcast\Core\Church::city() ) : ?>
							<div class="notice notice-warning inline">
								<p>
									<?php esc_html_e( 'This looks like it still holds the city and state. Move them into the fields below and leave only the street here, or they will appear twice.', 'seedcast-bulletin-library' ); ?>
								</p>
							</div>
						<?php endif; ?>
						<?php
						...
						<?php if ( '' !== $seedcast_directions ) : ?>
							<p>
								<a href="<?php echo esc_url( $seedcast_directions ); ?>" target="_blank" rel="noopener noreferrer">
									<?php esc_html_e( 'Check this address on the map', 'seedcast-bulletin-library' ); ?>
								</a>
								<span class="description">
									<?php esc_html_e( 'Opens the exact link visitors are given. If it lands somewhere else, fix the address above.', 'seedcast-bulletin-library' ); ?>
								</span>
							</p>
						<?php endif; ?>
					</td>
				...
				<tr>
					<th scope="row"><label for="seedcast_church_city"><?php esc_html_e( 'City', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						...
						<p class="description">
							<?php esc_html_e( 'Used in sentences that say where you are, which is also what search engines read to connect you to a place.', 'seedcast-bulletin-library' ); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="seedcast_church_state"><?php esc_html_e( 'State or county', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						...
						<p class="description">
							<?php esc_html_e( 'Written out rather than abbreviated reads better in a sentence: California, not CA.', 'seedcast-bulletin-library' ); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="seedcast_church_country"><?php esc_html_e( 'Country', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						...
						<p class="description">
							 ...
							 * a visitor would see.
							 */
							esc_html_e( 'Two-letter country code, such as US, CA or GB. Used when describing your church to search engines.', 'seedcast-bulletin-library' );
							?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="seedcast_church_postcode"><?php esc_html_e( 'Postcode or zip', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="seedcast_church_service_day"><?php esc_html_e( 'Service day', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						...
						<p class="description">
							<?php esc_html_e( 'The day your main gathering falls on. Plugins use this rather than assuming Sunday.', 'seedcast-bulletin-library' ); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="seedcast_church_service_times"><?php esc_html_e( 'Service times', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						...
						<p class="description">
							<?php esc_html_e( 'One per line, in your own words. For example: 9:00 AM Traditional, 11:00 AM Contemporary.', 'seedcast-bulletin-library' ); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="seedcast_church_phone"><?php esc_html_e( 'Phone', 'seedcast-bulletin-library' ); ?></label></th>
				...
				<tr>
					<th scope="row"><label for="seedcast_church_email"><?php esc_html_e( 'Contact email', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						...
						<p class="description">
							...
							printf(
								...
								esc_html__( 'Used as the reply-to address on mail sent on the church\'s behalf. Leave blank to use %s.', 'seedcast-bulletin-library' ),
				...
				<tr>
					<th scope="row"><label for="seedcast_church_events_url"><?php esc_html_e( 'Events page', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						...
						<p class="description">
							<?php esc_html_e( 'Optional. Where someone can see what is coming up.', 'seedcast-bulletin-library' ); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="seedcast_church_description"><?php esc_html_e( 'About this church', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						...
						<p class="description">
							 ...
							 * statement.
							 */
							esc_html_e( 'A sentence or two describing your church: where it is, what it believes, what a visitor would find. Given to search engines when they ask what this church is.', 'seedcast-bulletin-library' );
							?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php esc_html_e( 'Where else you are', 'seedcast-bulletin-library' ); ?></th>
					<td>
						<?php
						/*
						 ...
						 */
						foreach ( array(
							'seedcast_church_facebook'  => __( 'Facebook page', 'seedcast-bulletin-library' ),
							'seedcast_church_instagram' => __( 'Instagram profile', 'seedcast-bulletin-library' ),
							'seedcast_church_youtube'   => __( 'YouTube channel', 'seedcast-bulletin-library' ),
						...
						<?php endforeach; ?>
						<p class="description">
							<?php esc_html_e( 'The official addresses of your church on each. These tell a search engine that all of them are the same church.', 'seedcast-bulletin-library' ); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="seedcast_church_visitor_note"><?php esc_html_e( 'Note to visitors', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						...
						<p class="description">
							<?php esc_html_e( 'A short word to someone thinking about coming for the first time. Where to park, what people wear, what happens with their kids.', 'seedcast-bulletin-library' ); ?>
						</p>
					</td>
				</tr>
			</table>

			<h3><?php esc_html_e( 'Showing these on your site', 'seedcast-bulletin-library' ); ?></h3>
			<p class="description">
				<?php esc_html_e( 'Place this shortcode anywhere, or use the Church Details widget if you build with Elementor.', 'seedcast-bulletin-library' ); ?>
			</p>
			<p>
			...
			<p class="description">
				...
				printf(
					...
					esc_html__( 'Choose which parts to show with the show attribute: %s.', 'seedcast-bulletin-library' ),
	...
	public function render_appearance_section(): void {
		...
		$themes = array(
			'light'   => array(
				'label'   => __( 'Light', 'seedcast-bulletin-library' ),
				'desc'    => __( 'Clean white with a warm accent', 'seedcast-bulletin-library' ),
				'preview' => array( '#ffffff', '#c9975a', '#1f2937' ),
			),
			'dark'    => array(
				'label'   => __( 'Dark', 'seedcast-bulletin-library' ),
				'desc'    => __( 'Deep charcoal with a soft gold accent', 'seedcast-bulletin-library' ),
				'preview' => array( '#1e293b', '#e0b872', '#e2e8f0' ),
			),
			'warm'    => array(
				'label'   => __( 'Warm', 'seedcast-bulletin-library' ),
				'desc'    => __( 'Gold accents on white, near-black hover', 'seedcast-bulletin-library' ),
				'preview' => array( '#ffffff', '#d3b673', '#0c0c0e' ),
			),
			'minimal' => array(
				'label'   => __( 'Minimal', 'seedcast-bulletin-library' ),
				'desc'    => __( 'No shadows, pure typography', 'seedcast-bulletin-library' ),
				'preview' => array( '#ffffff', '#111827', '#6b7280' ),
			),
		);
		?>
		<div class="sc-settings-card">
			<h2><?php esc_html_e( 'Appearance', 'seedcast-bulletin-library' ); ?></h2>
			<p class="description">
				<?php esc_html_e( 'Applied across every Seedcast plugin on this site. Set it once here and any plugin you install later picks it up with no configuration.', 'seedcast-bulletin-library' ); ?>
			</p>
	...
	public function render_spam_section(): void {
		...
		?>
		<div class="sc-settings-card">
			<h2><?php esc_html_e( 'Spam protection', 'seedcast-bulletin-library' ); ?></h2>
			<p class="description">
				<?php esc_html_e( 'Applies to every submission form across the suite. Configured once, here.', 'seedcast-bulletin-library' ); ?>
			</p>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="seedcast_captcha_provider"><?php esc_html_e( 'Captcha provider', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
						<select name="seedcast_captcha_provider" id="seedcast_captcha_provider">
							<option value="none" <?php selected( $provider, 'none' ); ?>><?php esc_html_e( 'None', 'seedcast-bulletin-library' ); ?></option>
							<option value="recaptcha" <?php selected( $provider, 'recaptcha' ); ?>><?php esc_html_e( 'Google reCAPTCHA v2 (checkbox)', 'seedcast-bulletin-library' ); ?></option>
							<option value="hcaptcha" <?php selected( $provider, 'hcaptcha' ); ?>><?php esc_html_e( 'hCaptcha', 'seedcast-bulletin-library' ); ?></option>
							<option value="turnstile" <?php selected( $provider, 'turnstile' ); ?>><?php esc_html_e( 'Cloudflare Turnstile', 'seedcast-bulletin-library' ); ?></option>
						</select>
						<p class="description">
							<?php esc_html_e( 'The reCAPTCHA option renders the standard checkbox widget (v2). Use the site key and secret from a v2 reCAPTCHA in your Google admin console. v3 is not currently supported.', 'seedcast-bulletin-library' ); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="seedcast_captcha_site_key"><?php esc_html_e( 'Captcha site key', 'seedcast-bulletin-library' ); ?></label></th>
				...
				<tr>
					<th scope="row"><label for="seedcast_captcha_secret"><?php esc_html_e( 'Captcha secret key', 'seedcast-bulletin-library' ); ?></label></th>
				...
				<tr>
					<th scope="row"><?php esc_html_e( 'Honeypot', 'seedcast-bulletin-library' ); ?></th>
					<td>
						<label>
							<input type="checkbox" name="seedcast_honeypot_enabled" value="1" <?php checked( $honeypot, '1' ); ?> />
							<?php esc_html_e( 'Enable the hidden honeypot spam trap on all forms', 'seedcast-bulletin-library' ); ?>
						</label>
					</td>
				</tr>
			</table>
		...
		printf(
			...
			esc_html(
				sprintf(
					...
					__( 'These Seedcast plugins expect a newer shared library than the one currently active (%2$s): %1$s. Updating your other Seedcast plugins resolves this. Some features stay hidden until then.', 'seedcast-bulletin-library' ),
					implode( ', ', $names ),
