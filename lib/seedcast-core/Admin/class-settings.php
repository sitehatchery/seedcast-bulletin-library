...
final class Settings {
	...
	public function render_church_section(): void {
		...
		<div class="sc-settings-card">
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="sc_church_name"><?php esc_html_e( 'Church name', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="sc_church_address"><?php esc_html_e( 'Street address', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="sc_church_city"><?php esc_html_e( 'City', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="sc_church_state"><?php esc_html_e( 'State or county', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="sc_church_country"><?php esc_html_e( 'Country', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="sc_church_postcode"><?php esc_html_e( 'Postcode or zip', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="sc_church_service_day"><?php esc_html_e( 'Service day', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="sc_church_service_times"><?php esc_html_e( 'Service times', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="sc_church_phone"><?php esc_html_e( 'Phone', 'seedcast-bulletin-library' ); ?></label></th>
				...
				<tr>
					<th scope="row"><label for="sc_church_email"><?php esc_html_e( 'Contact email', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="sc_church_events_url"><?php esc_html_e( 'Events page', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="sc_church_description"><?php esc_html_e( 'About this church', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					...
					<td>
						 ...
						 */
						foreach ( array(
							'sc_church_facebook'  => __( 'Facebook page', 'seedcast-bulletin-library' ),
							'sc_church_instagram' => __( 'Instagram profile', 'seedcast-bulletin-library' ),
							'sc_church_youtube'   => __( 'YouTube channel', 'seedcast-bulletin-library' ),
						) as $sc_key => $sc_label ) :
							?>
							<p>
				...
				<tr>
					<th scope="row"><label for="sc_church_visitor_note"><?php esc_html_e( 'Note to visitors', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
	...
	public function render_spam_section(): void {
		...
		<div class="sc-settings-card">
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="sc_captcha_provider"><?php esc_html_e( 'Captcha provider', 'seedcast-bulletin-library' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="sc_captcha_site_key"><?php esc_html_e( 'Captcha site key', 'seedcast-bulletin-library' ); ?></label></th>
				...
				<tr>
					<th scope="row"><label for="sc_captcha_secret"><?php esc_html_e( 'Captcha secret key', 'seedcast-bulletin-library' ); ?></label></th>
