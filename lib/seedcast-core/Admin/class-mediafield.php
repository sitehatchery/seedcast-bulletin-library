...
class MediaField {
	...
	public static function render( array $args ): void {
		$args = wp_parse_args( $args, [
			...
			'description'  => '',
			'preview'      => true,
			'select_label' => __( '↑ Upload / Select', 'seedcast-bulletin-library' ),
			'clear_label'  => __( 'Clear', 'seedcast-bulletin-library' ),
		] );
		...
		$titles = [
			'video' => __( 'Select or Upload Video', 'seedcast-bulletin-library' ),
			'audio' => __( 'Select or Upload Audio', 'seedcast-bulletin-library' ),
			'image' => __( 'Select or Upload Image', 'seedcast-bulletin-library' ),
		];
		$buttons = [
			'video' => __( 'Use this video', 'seedcast-bulletin-library' ),
			'audio' => __( 'Use this audio', 'seedcast-bulletin-library' ),
			'image' => __( 'Use this image', 'seedcast-bulletin-library' ),
		];
		$picker_title  = $titles[ $type ]  ?? __( 'Select or Upload File', 'seedcast-bulletin-library' );
		$picker_button = $buttons[ $type ] ?? __( 'Use this file', 'seedcast-bulletin-library' );
		?>
