...
class ShareButtons {
	...
	public static function render( string $url, string $title, array $args = [] ): void {
		$heading = (string) ( $args['heading'] ?? __( 'Share', 'seedcast-bulletin-library' ) );
			...
			<ul class="sc-share__list">
				<li>
					<a class="sc-share__btn sc-share__btn--facebook"
					   ...
					   aria-label="<?php esc_attr_e( 'Share on Facebook. Opens in a new tab.', 'seedcast-bulletin-library' ); ?>">
				...
				<li>
					<a class="sc-share__btn sc-share__btn--x"
					   ...
					   target="_blank" rel="noopener noreferrer"
					   aria-label="<?php esc_attr_e( 'Share on X. Opens in a new tab.', 'seedcast-bulletin-library' ); ?>">
				...
				<li>
					<a class="sc-share__btn sc-share__btn--linkedin"
					   ...
					   target="_blank" rel="noopener noreferrer"
					   aria-label="<?php esc_attr_e( 'Share on LinkedIn. Opens in a new tab.', 'seedcast-bulletin-library' ); ?>">
				...
				<li>
					<a class="sc-share__btn sc-share__btn--email"
					   ...
					   aria-label="<?php esc_attr_e( 'Share by email', 'seedcast-bulletin-library' ); ?>">
						<span class="sc-share__icon" aria-hidden="true"><?php self::icon_email(); ?></span>
						<span class="sc-share__label"><?php esc_html_e( 'Email', 'seedcast-bulletin-library' ); ?></span>
					</a>
				</li>
				<li>
					<button type="button"
					        ...
					        aria-label="<?php esc_attr_e( 'Copy link', 'seedcast-bulletin-library' ); ?>">
						<span class="sc-share__icon" aria-hidden="true"><?php self::icon_link(); ?></span>
						<span class="sc-share__label sc-share__label--copy"><?php esc_html_e( 'Copy Link', 'seedcast-bulletin-library' ); ?></span>
						<span class="sc-share__label sc-share__label--copied" hidden><?php esc_html_e( 'Copied', 'seedcast-bulletin-library' ); ?></span>
					</button>
