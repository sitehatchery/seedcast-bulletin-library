...
class ElementorChurchWidget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Church Details', 'seedcast-bulletin-library' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'raw'             => esc_html__( 'These details are edited once under Settings, Seedcast, Church. Every place they appear updates together.', 'seedcast-bulletin-library' ),
		...
		$this->add_control(
			'heading',
			array(
				'label'       => __( 'Heading', 'seedcast-bulletin-library' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => __( 'Optional', 'seedcast-bulletin-library' ),
			)
		);
		...
		$this->add_control(
			'fields',
			array(
				'label'    => __( 'Show', 'seedcast-bulletin-library' ),
				...
				'options'  => array(
					...
					'events'     => __( 'Events link', 'seedcast-bulletin-library' ),
					'note'       => __( 'Note to visitors', 'seedcast-bulletin-library' ),
					'directions' => __( 'Directions button', 'seedcast-bulletin-library' ),
				),
			)
		);
		...
		$this->add_control(
			'layout',
			array(
				'label'   => __( 'Layout', 'seedcast-bulletin-library' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'default' => 'stacked',
				'options' => array(
					'stacked' => __( 'Stacked', 'seedcast-bulletin-library' ),
					'inline'  => __( 'Inline', 'seedcast-bulletin-library' ),
				),
			)
		);
	...
	protected function render() {
		...
		if ( '' === $html && \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
			$html = '<p class="sc-church__placeholder">'
				. esc_html__( 'Add your church details under Settings, Seedcast, Church.', 'seedcast-bulletin-library' )
				. '</p>';
		}
