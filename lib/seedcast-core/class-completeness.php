...
final class Completeness {
	...
	public static function tier( int $score ): array {
		if ( $score >= 100 ) {
			return array(
				'key'   => 'complete',
				'label' => __( 'Complete', 'seedcast-bulletin-library' ),
				'band'  => 'good',
			);
		}
		...
		if ( $score >= 80 ) {
			return array(
				'key'   => 'almost',
				'label' => __( 'Almost there', 'seedcast-bulletin-library' ),
				'band'  => 'good',
			);
		}
		...
		if ( $score >= 50 ) {
			return array(
				'key'   => 'needs_work',
				'label' => __( 'Needs work', 'seedcast-bulletin-library' ),
				'band'  => 'fair',
			);
		}
		...
		return array(
			'key'   => 'started',
			'label' => __( 'Just started', 'seedcast-bulletin-library' ),
			'band'  => 'poor',
		);
	}
