...
class SubmissionEngine {
	...
	public function insert( array $data ) {
		...
		if ( empty( $data['source'] ) || empty( $data['type'] ) ) {
			return new \WP_Error( 'sc_missing_source', __( 'Submission source and type are required.', 'seedcast-bulletin-library' ) );
		}
		...
		if ( false === $ok ) {
			...
			return new \WP_Error( 'sc_db_error', __( 'Could not save submission.', 'seedcast-bulletin-library' ) );
		}
